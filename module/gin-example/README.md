# Go Gin Example ![](https://img.shields.io/badge/iswxw-success-blue) ![](https://img.shields.io/badge/stars-1k-brightgreen) ![](https://img.shields.io/badge/fork-2k-orange) 
...
## 安装
```
$ go clone -b dev https://github.com/iswxw/wxw-go.git
```
...
创建一个 `blog` 数据库，并且导入建表的 [SQL](https://github.com/iswxw/wxw-go/blob/dev/module/gin-example/docs/gin.sql)

### 配置

你应该修改 `conf/app.toml` 配置文件

```

[mysql]
# 按需设置超时时间
dsn="root:123456@tcp(127.0.0.1:3306)/wxw?charset=utf8mb4&parseTime=True&loc=Local"
max_idle_connects = 20
max_open_connects = 20
# gorm 日志模式
log_mode = true
...
![image](https://img-blog.csdnimg.cn/79e627f3c34241758053c89d6d860f91.jpg)
