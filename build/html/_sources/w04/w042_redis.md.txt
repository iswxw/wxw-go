...
go语言操作`redis`有个包，一个是 `go-redis`，另一个是`redigo`,官方推荐第二种；
...
<img src="https://upload-images.jianshu.io/upload_images/14807846-997c0e2eb218800a?imageMogr2/auto-orient/strip|imageView2/2/w/500/format/webp" alt="img" style="zoom: 67%;" /> 