...
// TestHeapHelloWorld 堆涉及到小顶堆、优先队列、普通堆（大顶堆）三种
func TestHeapHelloWorld(t *testing.T) {
...
func TestRemove2(t *testing.T) {
	...
	m := make(map[int]bool)
	for h.Len() > 0 {
		m[heap.Remove(h, (h.Len()-1)/2).(int)] = true
		h.verify(t, 0)
	}
