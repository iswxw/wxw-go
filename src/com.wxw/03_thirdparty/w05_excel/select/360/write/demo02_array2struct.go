...
func Array2Struct() {
	...
	//结果在  arr 中
	var arr []dto.ExcelTest
	err = lib.NewExcelStructDefault().SetPointerStruct(&dto.ExcelTest{}).RowsAllProcess(rows, func(maps map[string]interface{}) error {
		var ptr dto.ExcelTest
		// map 转 结构体
	...
	err = lib.NewExcelStruct(1, 10).SetPointerStruct(&dto.ExcelTest{}).RowsAllProcess(rows, func(maps map[string]interface{}) error {
		var ptr dto.ExcelTest
		// map 转 结构体
		if err2 := mapstructure.Decode(maps, &ptr); err2 != nil {
			return err2
