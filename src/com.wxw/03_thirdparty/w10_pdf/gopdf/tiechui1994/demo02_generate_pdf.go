...
func main() {
	...
	r.Execute(basePath + "tmp/simple_table.pdf")
...
func SimpleTableExecutor(report *core.Report) {
	...
	f1 := core.Font{Family: TableMy, Size: 15, Style: ""}
	...
	f1 = core.Font{Family: TableMy, Size: 10}
	...
	if err := table.GenerateAtomicCell(); err != nil {
		fmt.Println(err)
		return
	}
}
